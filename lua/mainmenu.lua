...
local screen_mm_quit = Sprite.new(assets:getTexture("screen_mm_logo"))
local screen_mm_play = Sprite.new(assets:getTexture("screen_mm_logo"))
local screen_mm_options = Sprite.new(assets:getTexture("screen_mm_logo"))
