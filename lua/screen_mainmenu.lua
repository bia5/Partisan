...
--LOGO
screen["logo"] = newSprite("art_logo", "center", 1080*.1, 1920*.5, 1080*.3)

--Buttons
screen["buttons"] = newChild("center", 650, 1440, 270)

function choosePlay() state = STATE_CHOOSEPLAY end
screen["buttons"]["play"] = newButton("button_play", "center", "center", 350, 250, choosePlay)
